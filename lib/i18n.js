...
export const translations = {
  uz: {
    ...
    notFound: {
      title: "Vaqtincha texnik nosozlik",
      message: "Kechirasiz, bu sahifani ochishda vaqtincha muammo yuz berdi. Iltimos, bir necha daqiqadan so'ng qayta urinib ko'ring.",
      homeBtn: "Bosh sahifaga qaytish",
      contactText: "Muammo davom etsa,",
  ...
  ru: {
    ...
    notFound: {
      title: "Временная техническая неполадка",
      message: "Извините, при открытии этой страницы произошла временная ошибка. Пожалуйста, повторите попытку через несколько минут.",
      homeBtn: "Вернуться на главную",
      contactText: "Если проблема сохраняется,",
...
translations.en = {
  ...
  notFound: {
    ...
    message: "Sorry, we ran into a temporary problem loading this page. Please try again in a few minutes.",
    homeBtn: "Back to homepage",
    contactText: "If the problem continues,",
