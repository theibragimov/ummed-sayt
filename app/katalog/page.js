      ...
      <div className="grid grid-cols-2 gap-5 sm:gap-6 mb-6">
        {variants.map((v, i) => (
          <div key={v.id || i} className="flex flex-col">
            <ImgBox url={imageUrl} alt={v.label} isHit={v.hit} hitColor="#E91E8C" lang={lang} />
            ...
            <FadeList triggerKey={activeKat}>
              <div className="space-y-16 sm:space-y-20">
                {displayed.map(({ kategoriya, products }) => {
                  ...
                  const wideImg = ['kalopriyomniklar', 'pastalar', 'reabilitatsiya', 'ginekologik-mahsulotlar', 'glyukometrlar-va-test-poloskalari', 'vakuum-terapiya', 'kalopriyomniklar-abucel', 'insulin-qalam-ignalari', 'tibbiy-anjomlari'].includes(kategoriya?.slug);
